...
<body>
  ...
  <img class="banner-svg2" src="/img/logo.png" alt="" width="100px">
    ...
    @guest
    <button type="button" class="btn btn-primary mx-3" id="signup_btn"><a href="/registration/signup" id="signup">Sign up</a></button>
    <button type="button" class="btn btn-primary mx-3" id="signin_btn" href="/login" id="signin"><a href="/login">Sign in</a></button>
    @endguest
